...
object GoogleVsApple {
  ...
  lazy val myTweets: TweetSet = TweetReader.allTweets.filter(tw => myList.exists(s => tw.text.contains(s)))
  ...
  lazy val mytrending: TweetList = myTweets.union(myTweets).descendingByRetweet
}

object Main extends App {
  // Print the trending tweets 

  GoogleVsApple.mytrending foreach println
